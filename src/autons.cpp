...
void autonSkills() {
  scraper.set(true);
  wings.set(true);
  chassis.pid_odom_set({{0_in, 31_in},fwd, 90});
  chassis.pid_wait();
  topIntake.move(-127);
  middleIntake.move(127);
  bottomIntake.move(127);
  ...
  pros::delay(1500);
  chassis.pid_wait();
  chassis.pid_odom_set({{0_in, 31_in}, rev, 90});
  chassis.pid_wait();
  topIntake.move(0);
  middleIntake.move(0);
  bottomIntake.move(0);
  ...
  chassis.pid_wait();
  chassis.pid_odom_set({{-87_in, 32_in}, fwd, 90});
  chassis.pid_wait();
  chassis.pid_odom_set({{-76_in, 32_in}, rev, 90});
  wings.set(false);
  topIntake.move(-127);
  middleIntake.move(127);
  bottomIntake.move(127);
  ...
  chassis.pid_odom_set({{-109_in, 32_in}, fwd, 90});
  pros::delay(2000);
  scraper.set(false);
  chassis.pid_wait();
  chassis.pid_odom_set({{-76_in, 32_in}, rev, 90});
  ...
  chassis.pid_odom_set({{-87_in, 32_in}, fwd, 90});
  chassis.pid_wait();
  chassis.pid_odom_set({{-93.4_in, -62.8_in}, fwd, 90});
  scraper.set(true);
  wings.set(true);
  chassis.pid_wait();
  chassis.pid_odom_set({{-109.3_in, -62.8_in}, fwd, 90});
  pros::delay(2000);
  chassis.pid_wait();
  chassis.pid_odom_set({{-93.4_in, -62.8_in}, rev, 90});
  scraper.set(false);
  chassis.pid_wait();
  ...
  chassis.pid_wait();
  chassis.pid_odom_set({{5.734_in, -62.832_in}, fwd, 90});
  chassis.pid_wait();
  chassis.pid_odom_set({{-22.13_in, -62.832_in}, rev, 90});
  wings.set(false);
  pros::delay(2200);
  wings.set(true);
  scraper.set(true);
  chassis.pid_wait();
  chassis.pid_odom_set({{14_in, -62.832_in}, fwd, 90});
  pros::delay(2000);
  chassis.pid_wait();
  chassis.pid_odom_set({{-22.13_in, -62.832_in}, rev, 90});
  wings.set(false);
...
void AWP() {
  ...
  bottomIntake.move(127);
  chassis.pid_wait();
  chassis.pid_odom_set({{15_in, 36.4_in}, fwd, 90});
  chassis.pid_wait();
  pros::delay(50);
  topIntake.move(0);
  middleIntake.move(0);
...
void realAWP(){//match loads one, scores on all 3
  doublePark.set(false);
  chassis.pid_odom_set({{0_in, 35_in},fwd, 100});
  scraper.set(true);
  wings.set(true);
  ...
  bottomIntake.move(0);
  middleIntake.move(0); 
  topIntake.move(0);//21,-28
  chassis.pid_odom_set({{-38.5_in, -3.5_in}, rev, 90});
  chassis.pid_wait();
  bottomIntake.move(127);
  middleIntake.move(127); 
  topIntake.move(-127);
  chassis.pid_odom_set({{-26.6_in, -43.5_in}, fwd, 90});
  scraper.set(true);
  chassis.pid_wait();
  chassis.pid_odom_set({{14_in, -64_in, 90_deg}, fwd, 90});
  // pros::delay(20);
  // chassis.pid_wait();
  // bottomIntake.move(0);
  // middleIntake.move(0);
  // topIntake.move(0);  
  // wings.set(false);
  chassis.pid_odom_set({{-20_in, -63_in}, rev, 90});
  bottomIntake.move(127);
  middleIntake.move(127); 
  topIntake.move(-127);
  chassis.pid_wait();
...
void testAWP(){//match loads both, scores on all 3
  ...
  middleIntake.move(127);
  bottomIntake.move(127);
  chassis.pid_odom_set({{-31.5_in, 5.5_in, -180_deg}, fwd, 70});
  pros::delay(1100);
  scraper.set(true);
  pros::delay(250);
  scraper.set(false);
  chassis.pid_wait();
  chassis.pid_odom_set({{-31.5_in, -43.5_in, 135_deg}, fwd, 90});
  pros::delay(1800);
  scraper.set(true);
  chassis.pid_wait();
  chassis.pid_odom_set({{-44.5_in, -26.5_in, 90_deg}, fwd, 90});
  chassis.pid_wait();
  topIntake.move(127);
  wings.set(false);
  pros::delay(500);
  wings.set(true);
  chassis.pid_odom_set({{0_in, -61.5_in, 90_deg}, fwd, 90});
  chassis.pid_wait();
  chassis.pid_odom_set({{14_in, -61.5_in}, fwd, 90});
  chassis.pid_wait();
  pros::delay(50);
  bottomIntake.move(0);
  middleIntake.move(0);
  topIntake.move(0);  
  wings.set(false);
  chassis.pid_odom_set({{-22_in, -61.5_in}, rev, 90});
  pros::delay(900);
  bottomIntake.move(127);
  middleIntake.move(127);
  topIntake.move(-127);
