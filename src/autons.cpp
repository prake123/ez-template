...
void wingRushRight(){
  scraper.set(true);
  wings.set(true);
  chassis.pid_odom_set({{0_in, 35_in},fwd, 90});//align to loader
  chassis.pid_wait();
  topIntake.move(-127);
  middleIntake.move(127);
  bottomIntake.move(127);
  chassis.pid_turn_set(90_deg, 127);//turn to loader
  chassis.pid_wait();
  chassis.pid_odom_set({{17_in, 35_in}, fwd, 90});//go to loader
  chassis.pid_wait();
  pros::delay(200);
  topIntake.move(0);
  middleIntake.move(0);
...
void long4middle3right() {//lowkey goated auton
  ...
  chassis.pid_odom_set({{0_in, 34_in},fwd, 100});
  scraper.set(true);
  wings.set(true);
  chassis.pid_wait();
  ...
  bottomIntake.move(127);
  chassis.pid_wait();
  chassis.pid_odom_set({{17_in, 34_in}, fwd, 60});
  chassis.pid_wait();
  pros::delay(100);
  topIntake.move(0);
  middleIntake.move(0);
  bottomIntake.move(0);
  wings.set(false);
  chassis.pid_odom_set({{-23_in, 35.0_in}, rev, 120});
  pros::delay(920);
    topIntake.move(-127);
  middleIntake.move(127);
  bottomIntake.move(127);
  ...
  chassis.pid_odom_set({{-9_in, 36.3_in}, fwd, 120});
  chassis.pid_wait();
  wings.set(true);
  chassis.pid_wait();
  topIntake.move(-127);
  middleIntake.move(127);
  bottomIntake.move(127);
  chassis.pid_odom_set({{-30.5_in, 3.5_in}, fwd, 90});
  pros::delay(1100);
  ...
  topIntake.move(0);  
  wings.set(false);
  chassis.pid_odom_set({{-34.81_in, 1_in,-135_deg}, fwd, 127});
  ...
  topIntake.move(-127);
  pros::delay(1500);
  chassis.pid_odom_set({{-16_in, 22_in}, rev, 120});
  chassis.pid_wait_quick();
  ...
  bottomIntake.move(127);
  chassis.pid_wait();
  chassis.pid_odom_set({{-16_in, 34_in}, fwd, 90});
  chassis.pid_wait();
  pros::delay(400);
  topIntake.move(0);
  middleIntake.move(0);
  bottomIntake.move(0);
  wings.set(false);
  chassis.pid_odom_set({{23_in, 36.3_in}, rev, 100});
  chassis.pid_wait_quick();
  topIntake.move(-127);
  middleIntake.move(127);
  bottomIntake.move(127);
  ...
  chassis.pid_wait();
  //chassis.pid_odom_set({{-17_in, 36.3_in}, fwd, 60});
  chassis.pid_odom_set({{9_in, 36.3_in}, fwd, 100});
  chassis.pid_wait();
  wings.set(true);
  chassis.pid_wait();
  topIntake.move(-127);
  middleIntake.move(127);
  bottomIntake.move(127);
  chassis.pid_odom_set({{31.5_in, 5.5_in}, fwd, 90});
  pros::delay(1100);
  scraper.set(true); //it works without scraper since i slowed it from 70 to 50
  pros::delay(250);
  scraper.set(false);
  ...
  topIntake.move(0);  
  wings.set(false);
  chassis.pid_turn_set(-35_deg,100);
  chassis.pid_wait_quick();
  chassis.pid_odom_set({{39_in, -2_in}, rev, 90});
  chassis.pid_wait_quick();
  chassis.pid_wait();
  chassis.pid_drive_set(-2_in, 20);
  chassis.pid_wait();
  ...
  topIntake.move(127);
  pros::delay(2000);
  chassis.pid_odom_set({{16_in, 22_in}, fwd, 90});
  chassis.pid_wait_quick();
  chassis.pid_turn_set(-90,90);
  chassis.pid_drive_set(-24_in,127);
  chassis.pid_wait();
...
void sawp(){//works pretty well try not to change anything
  ...
  bottomIntake.move(127);
  chassis.pid_wait_quick();
  chassis.pid_odom_set({{17.1_in, 36_in}, fwd, 70});//at match loader
  pros::delay(1050);
  wings.set(true);
  ...
  //chassis.pid_wait();
  pros::delay(1300);
  chassis.pid_turn_relative_set(95,127);
  chassis.pid_wait_quick();
  chassis.pid_odom_set({{-18_in, 25_in}, fwd, 127});
  chassis.pid_wait_quick_chain();
  wings.set(true);
  scraper.set(true);
  chassis.pid_odom_set({{-20_in, 14_in}, fwd, 127});
  chassis.pid_wait_quick_chain();
  scraper.set(false);
  chassis.pid_odom_set({{-22_in, -22_in}, fwd, 127});
  chassis.pid_wait_quick_chain();
  scraper.set(true);
  ...
  // move blocks out of middle intake
  ...
  pros::delay(10000);
/*
  chassis.pid_drive_set(72_in,127);
  chassis.pid_wait();
  wings.set(true);
  topIntake.move(-127); 
  middleIntake.move(127);
  ...
  // pros::delay(150);
  chassis.pid_wait_quick();
  chassis.pid_turn_set(-220_deg, 127);//turn to middle
  chassis.pid_wait_quick(); 
  // chassis.pid_odom_set({{-39.1_in, -30.2_in}, rev, 127});//go to middle used to be -38.6,-29.2
  chassis.pid_drive_set(-22_in, 127); // changed from -15
  chassis.pid_wait_quick();
  ...
  bottomIntake.move(0);*/
/*
  chassis.pid_odom_set({{{0_in, -65_in}, fwd, 127}});//go towards match loader
  topIntake.move(-127);
  middleIntake.move(-127);
  ...
  middleIntake.move(127); 
  bottomIntake.move(127);
  chassis.pid_odom_set({{17_in, -65.5_in}, fwd, 70});//
  // scrape match loader
  scraper.set(true);
